...
if fl is not None:
    ...
    # Change to a relative directory (if needed)
    # os.chdir(os.path.join(current_directory, "test"))  # Uncomment if necessary

    # Load the CSV data, assuming it's in the same directory
    data_path = os.path.join(current_directory, "c_previous_application.xlsx")
